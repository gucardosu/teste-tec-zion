  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-between px-12 py-20 relative overflow-hidden min-h-[85vh]">
      <div className="md:w-1/2 flex flex-col gap-6 z-10">
        ...
        >
          A HØST é mais do que um fornecedor — somos o parceiro estratégico que
          te entende, direciona e conecta o seu negócio às melhores soluções em
          equipamentos, serviços e gestão. <br />
          <br />
